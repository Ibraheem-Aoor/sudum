...
class RegisterController extends Controller
{
    ...
    */
    ...
    protected function create(array $data)
    {
        ...
        /* الكود الخاص بعرض الهوية الوطنية التي يضعها المستخدم عند انشاء حساب جديد */
        ...
        /* الكود الخاص بعرض الدرجات العلمية التي يضعها المستخدم عند انشاء حساب جديد */
        if (!empty($data['educational_qualification'])) {
            UserMeta::updateOrCreate([
                'user_id' => $user->id,
                'name' => 'education'
            ], [
