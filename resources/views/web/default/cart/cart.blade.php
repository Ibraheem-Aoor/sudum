...
@section('content')
    <section class="cart-banner position-relative text-center">
        <h1 class="font-30 text-secondary font-weight-bold">{{ trans('cart.shopping_cart') }}</h1>
        <span class="payment-hint font-20 text-secondary d-block"> {{ handlePrice($subTotal, true, true, false, null, true) . ' ' . trans('cart.for_items',['count' => $carts->count()]) }}</span>
    </section>
    ...
    <div class="container">
        ...
        <section class="mt-45">
            ...
            <div class="rounded-sm shadow mt-20 py-25 px-10 px-md-30">
                ...
                <button type="button" onclick="window.history.back()" class="btn btn-sm btn-gray mt-25">{{ trans('cart.continue_shopping') }}</button>
            </div>
        </section>
        ...
        <form action="/cart/checkout" method="post" id="cartForm">
            ...
            <div class="row mt-30">
                ...
                <button type="submit" class="btn btn-primary mt-30" style="width: 100%;">المتابعة للدفع</button>
