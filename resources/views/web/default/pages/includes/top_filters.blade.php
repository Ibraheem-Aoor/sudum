<div id="topFilters" class="shadow-lg border border-gray300 rounded-sm p-10 p-md-20">
    <div class="row align-items-center">
        <div class="col-lg-9 d-flex align-items-center">
            ...
            <!-- First Link -->
            <div class="d-flex align-items-center justify-content-between justify-content-md-center mb-2" style="margin-right: 20px;">
            ...
            <div class="d-flex align-items-center justify-content-between justify-content-md-center mb-2" style="margin-right: 20px;">
                <label class="mb-0 mr-10 cursor-pointer">
                    <a href="/categories/qualifying-courses" class="position-relative font-14 text-secondary">الدورات التأهيلية</a>
                </label>
            </div>
            ...
            <div class="d-flex align-items-center justify-content-between justify-content-md-center mb-2" style="margin-right: 20px;">
                <label class="mb-0 mr-10 cursor-pointer">
                    <a href="/categories/development-courses" class="position-relative font-14 text-secondary">الدورات التطويرية</a>
                </label>
            </div>

            <div class="d-flex align-items-center justify-content-between justify-content-md-center mb-2" style="margin-right: 20px;">
                <label class="mb-0 mr-10 cursor-pointer">
                    <a href="/categories/courses-selected-for-you" class="position-relative font-14 text-secondary">دورات مختارة لك</a>
                </label>
            </div>
