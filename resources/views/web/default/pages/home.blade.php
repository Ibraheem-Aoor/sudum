...
@section('content')
    ...
    @if(!empty($heroSectionData))
        ...
        {{-- تعديل جزء الهيروسيكشن وعرض خلفية لون بدل من صورة خريطة العالم --}}
        <section class="slider-container  {{ ($heroSection == "2") ? 'slider-hero-section2' : '' }}" @if(empty($heroSectionData['is_video_background'])) style="{{-- background-image: url('{{ $heroSectionData['hero_background'] }}') --}}background-color:#EFFAFF; min-height: 530px;" @endif>
                    ...
                    <div class="row slider-content align-items-center hero-section2 flex-column-reverse flex-md-row">
                        <div class="col-12 col-md-7 col-lg-6">
                            ...
                            <form action="/search" method="get" class="d-inline-flex mt-30 mt-lg-30 w-100">
                                <div class="form-group d-flex align-items-center m-0 slider-search p-4-n bg-white w-100">
                                    <input type="text" name="search" class="form-control border-0 mr-lg-10" placeholder="{{ trans('home.slider_search_placeholder') }}"/>

                                    <button type="submit" class="btn btn-primary" style="border-radius: 38px 0px 38px 38px;">
    ...
    @foreach($homeSections as $homeSection)
            ...
            @if($homeSection->name == \App\Models\HomeSection::$latest_bundles and !empty($latestBundles) and !$latestBundles->isEmpty())
                <section class="home-sections home-sections-swiper container">
                    <div class="d-flex justify-content-between ">
                        ...
                        <a href="/classes?type[]=bundle" class="btn btn-border-white rounded-pill">{{ trans('home.view_all') }}</a>
                    </div>
                        ...
                        <div class="swiper-container latest-bundle-swiper px-12">
                            <div class="swiper-wrapper py-20">
                                @foreach($latestBundles as $latestBundle)
                                    <div class="swiper-slide">
                                        @include('web.default.includes.webinar.grid-card-diploma',['webinar' => $latestBundle])
                                    </div>
                                @endforeach
        ...
        {{-- @if($homeSection->name == \App\Models\HomeSection::$upcoming_courses and !empty($upcomingCourses) and !$upcomingCourses->isEmpty())
            <section class="home-sections home-sections-swiper container">
                <div class="d-flex justify-content-between ">
                    ...
                    <a href="/upcoming_courses?sort=newest" class="btn btn-border-white rounded-pill">{{ trans('home.view_all') }}</a>
                </div>
        ...
        {{-- احدث الدورات تصميم الاسلايدر وهو لاغي  --}}
            {{--
                @if($homeSection->name == \App\Models\HomeSection::$latest_classes and !empty($latestWebinars) and !$latestWebinars->isEmpty())
                    <section class="home-sections home-sections-swiper container">
                        <div class="d-flex justify-content-between ">
                            ...
                            <a href="/classes?sort=newest" class="btn btn-border-white rounded-pill">{{ trans('home.view_all') }}</a>
                        </div>
        ...
        {{-- The Database rules inquiry has been updated so that the latest chapters are the development courses 13-12-2023 --}}
            @if($homeSection->name == \App\Models\HomeSection::$latest_classes and !empty($latestWebinars) and !$latestWebinars->isEmpty())
                <div class="container mt-30">
                    <section class="mt-lg-50 pt-lg-20 mt-md-40 pt-md-40">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="/categories/development-courses" class="btn btn-border-white rounded-pill">{{ trans('home.view_all') }}</a>
                        </div>
        ...
        {{-- افضل الفصول تقييما تصميم السلايدر وهو لاغي --}}
            {{--
                @if($homeSection->name == \App\Models\HomeSection::$best_rates and !empty($bestRateWebinars) and !$bestRateWebinars->isEmpty())
                    <section class="home-sections home-sections-swiper container">
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="/classes?sort=best_rates" class="btn btn-border-white rounded-pill">{{ trans('home.view_all') }}</a>
                        </div>
        ...
        {{-- The Database rules inquiry has been updated so that the latest chapters are the qualifying courses 13-12-2023 --}}
            @if($homeSection->name == \App\Models\HomeSection::$best_rates and !empty($bestRateWebinars) and !$bestRateWebinars->isEmpty())
                <div class="container mt-30">
                    <section class="mt-lg-50 pt-lg-20 mt-md-40 pt-md-40">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="/categories/qualifying-courses" class="btn btn-border-white rounded-pill">{{ trans('home.view_all') }}</a>
                        </div>
        ...
        {{--
            ...
            <section class="home-sections container">
                <div class="d-flex justify-content-between">
                    ...
                    <a href="/classes?sort=bestsellers" class="btn btn-border-white rounded-pill">{{ trans('home.view_all') }}</a>
                </div>
        ...
        {{-- The Database rules inquiry has been updated so that the latest chapters are the selected for you courses 13-12-2023 --}}
            ...
            <section class="home-sections container">
                <div class="d-flex justify-content-between">
                    ...
                    <a href="/categories/courses-selected-for-you" class="btn btn-border-white rounded-pill">{{ trans('home.view_all') }}</a>
                </div>
        ...
        {{--
            ...
            <section class="home-sections home-sections-swiper container">
                <div class="d-flex justify-content-between">
                    ...
                    <a href="/classes?free=on" class="btn btn-border-white rounded-pill">{{ trans('home.view_all') }}</a>
                </div>
        ...
        {{--
            ...
            <section class="home-sections home-sections-swiper container">
                <div class="d-flex justify-content-between">
                    ...
                    <a href="/products" class="btn btn-border-white rounded-pill">{{ trans('update.all_products') }}</a>
                </div>
        ...
        {{--
            ...
            <section class="home-sections container">
                <div class="d-flex justify-content-between">
                    ...
                    <a href="/instructors" class="btn btn-border-white rounded-pill">{{ trans('home.all_instructors') }}</a>
                </div>
        ...
        {{--
            ...
            <section class="home-sections home-sections-swiper container">
                <div class="d-flex justify-content-between">
                    ...
                    <a href="/organizations" class="btn btn-border-white rounded-pill">{{ trans('home.all_organizations') }}</a>
                </div>
            ...
            @if($homeSection->name == \App\Models\HomeSection::$blog and !empty($blog) and !$blog->isEmpty())
                <section class="home-sections container">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="/blog" class="btn btn-border-white rounded-pill">{{ trans('home.all_blog') }}</a>
                    </div>
