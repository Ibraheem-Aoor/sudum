...
<nav id="navbar" class="navbar navbar-expand-lg navbar-chcolor" id="navbar">
        ...
        <div class="d-flex align-items-center justify-content-between w-100">
            ...
            <div class="mx-lg-30 d-none d-lg-flex flex-grow-1 navbar-toggle-content " id="navbarContent">
                ...
                <ul class="navbar-nav mr-auto d-flex align-items-center">
                    ...
                    <!-- اخفاء الجزء الخاص بعرض الاقسام -->
                    {{--
            ...
            <div class="nav-icons-or-start-live navbar-order d-flex align-items-center justify-content-end">
                ...
                @if(!empty($navBtnUrl))
                    <a href="{{ $navBtnUrl }}" class="d-none d-lg-flex btn btn-sm btn-primary rounded-pill" style="margin-left: 20px;">
                        {{-- {{ $navBtnText }} --}}
                        ابدأ التدريب
                    </a>

                    <a href="{{ $navBtnUrl }}" class="d-flex d-lg-none text-primary rounded-pill font-14">
                        {{-- {{ $navBtnText }} --}}
                        ابدأ التدريب
                    </a>
                @endif
