                                        ...
                                        <div class="col-12 col-md-5">
                                            ...
                                            <div class="form-group mt-15">
                                                ...
                                                <input type="number" name="points"
                                                    ...
                                                    placeholder="{{ __('public.empty_to_inactive') }}" />
                                                @error('points')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                ...
                                <section class="mt-3">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                                    ...
                                                    @foreach ($categories as $category)
                                                            ...
                                                            <optgroup label="{{ $category->title }}">
                                                                @foreach ($category->subCategories as $subCategory)
                                                                    <option value="{{ $subCategory->id }}"
                                                                        ...
                                                                        @if(old('number_of_hours') && old('number_of_hours') == $subCategory->id) selected @endif>
                                                        ...
                                                        @else
                                                            <option value="{{ $category->id }}"
                                                                ...
                                                                @if (old('number_of_hours') && old('number_of_hours') == $category->id) selected @endif>
                                            ...
                                            <div class="form-group">
                                                <label title="({{ trans('public.number_of_hours_hint') }})"
                                                    class="input-label">{{ trans('public.number_of_hours') }}
                                                    <small>({{ trans('public.number_of_hours') }})</small>
                                                </label>
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text" id="timeInputGroupPrepend">
                                                    ...
                                                    <input type="number" name="number_of_hours"
                                                        value="{{ !empty($webinar) ? $webinar->number_of_hours : old('number_of_hours') }}"
                                                        class="form-control @error('number_of_hours')  is-invalid @enderror" />
