    ...
    <section class="section">
        <div class="d-flex flex-wrap align-items-stretch">
            ...
            <div class="text-light p-5 pb-2">
              <div class="mb-2 pb-3">
                <h1 class="mb-2 display-4 font-weight-bold">سدم المعرفة</h1>
                <h5 class="font-weight-normal text-muted-transparent">منصة تعليمية كاملة المواصفات</h5>
              </div>
              جميع الحقوق محفوظة <a class="text-light bb" target="_blank" href="#">سدم المعرفة</a>
            </div>
          </div>
            </div>
